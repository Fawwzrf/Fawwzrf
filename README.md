...
* **Current Project** `:`
  - **BrailleVision** : BrailleVision is an innovative edge-computing mobile application designed for real-time translation of physical Braille documents into alphabetical text using a smartphone camera. It employs a hybrid approach, combining Digital Image Processing for cell extraction with a lightweight Machine Learning model (MobileNetV3-Small) for character classification.
