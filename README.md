...
* **Current Project** `:`
  - **BrailleVision** : BrailleVision is an innovative edge-computing mobile application that translates physical Braille documents into real-time alphabetic text using a smartphone camera. Operating 100% offline, it leverages a hybrid approach of Digital Image Processing and lightweight Machine Learning for robust, tremor-resistant character classification.
