...
* **Current Project** `:`
  - **BrailleVision** : BrailleVision is an innovative edge-computing mobile application designed for real-time translation of physical Braille documents into alphabetical text using a smartphone camera. Operating entirely offline, it features a Temporal Voting Buffer to enhance stability and responsiveness, providing a reliable interface for visually impaired individuals and educators.
