...
* **Current Project** `:`
  - **BrailleVision** : BrailleVision is an innovative edge-computing mobile application designed to translate physical Braille documents into alphabetical text in real-time using a smartphone camera. It operates 100% offline, employing a hybrid approach of Digital Image Processing and a lightweight Machine Learning model for robust character classification.
