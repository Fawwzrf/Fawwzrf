...
* **Current Project** `:`
  - **BrailleVision** : BrailleVision is an innovative edge-computing mobile application designed for real-time translation of physical Braille documents into alphabetical text via smartphone cameras. It utilizes a hybrid approach combining efficient Digital Image Processing with a lightweight Machine Learning model for robust, offline character classification.
